...
//key api AIzaSyC_HDLaa_jMVQvYwpnFvHqJ3JAVyzFE6FY
const perguntarAI = async (question, game, apiKey) => {
    ...
    const pergunta = `
      ...
      ## Regra 
      - Se você nâo sabe a resposta, responda com 'Nâo sei' e nâo tente inventar uma resposta.
      - se a pergunta nâo esta relacionada ao jogo, responda com 'Essa pergunta não esta relacionada ao jogo'
      - considere a data atual ${new Date().toLocaleDateString()}
      - Faça pesquisas atualizadas sobre o patch atual, baseado na data atual, para dar uma resposta coerente.
      - Nunca responda itens que vc não tenha certeza de que existe no patch atual.
    /**
      ## Resposta
        Pergunta do usuário : Melhor build rengar junngle
